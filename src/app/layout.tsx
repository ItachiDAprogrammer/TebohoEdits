...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Professional video editing services for YouTube and Instagram. Clean edits, engaging pacing, and social-media-optimized visuals.",
  ...
  twitter: {
    ...
    title: "Teboho Edits - Creative Video Editor",
    description:
      "Professional video editing services for YouTube and Instagram.",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className="dark h-full">
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} bg-black text-white antialiased h-full`}
      >
